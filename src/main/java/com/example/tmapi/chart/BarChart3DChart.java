...
public class BarChart3DChart {
    public BarChart3DChart(){}
    ...
    public ChartPanel createChart(String path) {
        //2：创建Chart[创建不同图形]
        JFreeChart chart = ChartFactory.createBarChart3D("Monthly Average Rainfall", "", "Rainfall (mm)", createDataset(),PlotOrientation.VERTICAL,true,false, false);
