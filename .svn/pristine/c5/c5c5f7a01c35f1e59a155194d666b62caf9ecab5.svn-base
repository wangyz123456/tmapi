...
public class DataUtil {
    ...
    public static Date lastMonth(){
        ...
        calendar.add(Calendar.MONTH, -1);//当前月份减1，为上一个月
     ...
     * @return date
     */
    public static Date initToDayDateByMonth(){
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(new Date());
        calendar.set(Calendar.HOUR_OF_DAY, 0);
        calendar.set(Calendar.MINUTE, 0);
     ...
     * @return date
     */
    public static Date initToDayDateByMonth1(){
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(new Date());
     ...
     * @return date
     */
    public static Date initYestDayDateByMonth(){
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(new Date());
